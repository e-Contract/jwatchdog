...
public abstract class AbstractDatasourceProvider<T> implements
		DatasourceProvider {
	...
	public AbstractDatasourceProvider(String configNamespace,
	...
	public Datasource loadDatasource(Element configElement) throws Exception {
		...
		return loadDatasource(config);
	}

	protected abstract Datasource loadDatasource(T config) throws Exception;
}
